export function init() {
  ...
  function renderizarVersionWeb(contenedor) {
    // Desordenar los pasos inicialmente
    ...
    let pasos = [...pasosDesordenadosIniciales];
    let resultado = "";
    let correctCount = 0;
    let ordenando = false;
    let porcentaje = 0;
    ...
    function crearTarjetaPasoWeb(paso, index) {
      ...
      if (resultado) {
        ...
        icono.src = esCorrecto ? '../../assets/img/btn_validacion/checkAct.png' : '../../assets/img/btn_validacion/xmarkAct.png';
    ...
    function reiniciarPasos() {
      pasos = [...pasosDesordenadosIniciales];
      resultado = "";
      correctCount = 0;
      porcentaje = 0;
      ordenando = false;
