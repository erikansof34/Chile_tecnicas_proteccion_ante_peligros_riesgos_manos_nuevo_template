...
const LESSONS_INFO = {
    'leccion1': {
        title: 'Lección 1: Identificación de Riesgos',
        description: 'Identifiquemos Técnicas de protección ante peligros y riesgos para las manos, en contextos laborales'
    },
    'leccion2': {
        title: 'Lección 2: Uso correcto de EPP',
        description: 'Promover el correcto uso de los EPP, para la protección de las manos'
    },
    'leccion3': {
        title: 'Lección 3: Gestión de Protocolos Preventivos',
        description: 'Gestionar protocolos de primeros auxilios y evaluación de incidentes'
    },
    'inicio': {
        title: 'Guía del Usuario - Tecnicas de protección ante peligros y riesgos para las manos',
...
function generateManifest(lessonId, isUnified = false) {
    ...
    if (isUnified) {
        ...
        resourceHref = 'index.html'; // Para lecciones, usar wrapper SCORM
    }
...
function generateFileList(isUnified, lessonId) {
    ...
    if (!isUnified && lessonId !== 'inicio') {
        ...
        const momentPatterns = {
            'leccion1': ['momento1_1', 'momento1_2', 'momento1_3', 'momento1_4', 'momento1_5', 'momento1_6', 'momento1_7', 'momento1_8'],
            'leccion2': ['momento2_1', 'momento2_2', 'momento2_3', 'momento2_4', 'momento2_5', 'momento2_6', 'momento2_7'],
...
async function buildLesson(lessonId) {
    ...
    try {
        ...
        // Copiar wrapper SCORM
        console.log('\n⚙️ Configurando wrapper SCORM...');
        await fs.copy(
            path.join(WRAPPERS_DIR, 'scorm', 'index.html'),
            path.join(DIST_DIR, 'index.html')
        );
        console.log('✓ Wrapper SCORM copiado');
